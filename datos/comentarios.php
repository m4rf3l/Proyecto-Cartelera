	...
	<body>
		<div class="container">
			...
			<div class="row text-center">
				<div class="col-xs-12">
					...
					<?php
						if ($sql) {
					?>		
							<h4 style="color: green" class="h4-contacto">Comentarios enviados con éxito</h4>
					<?php
						} else	{
					?>		
							<h4 style="color: reed" class="h4-contacto">Error al enviar comentarios.</h4>
					<?php	
						}	
							$conexion->close();
					?>
			...
			<div class="row separa-form">
				<form method="post" action="comentarios.php" name="formContacto" onsubmit="return validarContacto()">
